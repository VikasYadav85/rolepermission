...
<div class="row" id="basic-table">
  ...
  <div class="col-12">
    <div class="card">
      ...
      @if($create)<a href="{{url('admin/roles/create')}}"><button class="btn btn-primary">Create Role</button></a>@endif
    ...
    <table class="table" id="dataTableExample1">
      <thead>
        <tr>
          ...
          <th>Role</th>
          <th>Status</th>
         @if($canDelete || $GivePermission || $canEdit)
          <th>Action</th>
          @endif
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
         ...
         @if($canEdit)
                <a class="dropdown-item" href="{{ URL('admin/roles/'.$user->id.'/edit')}}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
           ...
           @if($canDelete)          
                <a class="dropdown-item" href="{{ url('admin/roles/'.$user->id.'/destroy')}}">
          ...
          @endif
          @if($GivePermission)
              <a class="dropdown-item" href="{{ URL('admin/roles/'.$user->id.'/addpermissiontorole')}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="feather feather-edit-2 me-50">
                  <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
