		...
		<div class="col-md-12 col-12">
			<div class="card">
				<div class="card-header ">
					<h1 class="card-title" style="font-size:27px;">View User</h1>
				</div>
				<hr class="bold-line">
				<div class="card-body">
						...
						<div class="row">
							<div class="col-6">
								<div class="mb-1">
									...
									<input type="text" id="title" readonly value="{{$user->name}}" class="form-control" name="name" placeholder="Name" required>
								</div>
							</div>
                            <div class="col-6">
                                <div class="mb-1">
                                    <label class="form-label" for="contact-info-vertical">Role <b style="color:red; font-size: 18px;font-weight:bold;">*</b></label>
                                    <select class="form-control" name="roles[]" id="roles" disabled required >
                            ...
                            <div class="col-6">
								<div class="mb-1">
									...
									<input type="email" id="Email" readonly value="{{ $user->email }}" class="form-control" name="email" placeholder="Email" required>
								</div>
							</div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge form-password-toggle">
                                        <input class="form-control form-control-merge"  readonly value="" id="password" type="password" name="password" placeholder="············" aria-describedby="login-password" tabindex="2" required />
                            ...
                            <div class="col-6">
								<div class="mb-1">
									...
									<input type="numbar" id="contact_number" value="{{ $user->contact_number }}" class="form-control" name="contact_number" placeholder="contact_number" readonly>
								</div>
							</div>
                            {{--  <div class="col-6">
								<div class="mb-1">
							...
							{{--  <div class="col-12">
								<div class="mb-1">
									...
									<textarea class="form-control" name="short_discription" readonly
